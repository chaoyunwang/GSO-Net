...
```
### Task-pretrained_model
The pretrained model corresponding to each experiment in the paper are provided here: [Task-pretrained_model](https://pan.baidu.com/s/1HHdra4dXLSlORJ_pufKWKA?pwd=lpx4 ).
```
├─Task-pretrained_model
  ├─Developable
...
```
### Task-test_result
The test result  corresponding to each experiment in the paper are provided here: [Task-test_result](https://pan.baidu.com/s/13ZKN6FJIXi0PFUnFZ0U_2w?pwd=50fp)(2GB).
```
├─Task-test_result
  ├─Developable
  │  ├─Developable_Net-C
...
```
### Figure-file
The source file corresponding to the surface optimization image involved in the paper and supplementary materials, can be available here: [Figure-file](https://pan.baidu.com/s/1_85v8fakIsOwaBquoxjsOA?pwd=oadw).
```
├─Figure-file
  ├─paper
  │  ├─Figure7
